      ...
      <div className="w-full md:py-20">
         <Wrapper>
            <div className="text-center max-w-[800px] mx-auto mt-8 md:mt-0">
               <h2 className="text-[28px] md:text-[34px] mb-5 font-semibold leading-tight">Shopping Cart</h2>
            </div>
               ...
               <div className="flex-[1]">
                  ...
                  <div className="p-5 my-5 bg-black/[0.05] rounded-xl">
                     <div className="flex justify-between">
                        <h4 className="text-md md:text-lg font-medium text-black">
                           Subtotal:
                        </h4>
                        <p className="text-md md:text-lg font-medium text-black">₹ 19.695</p>
                     </div>
                  ...
                  <button
                     className="w-full py-4 rounded-full bg-black text-white text-lg font-medium transition-transform
                         active:scale-95 mb-3 hover:opacity-75 flex items-center gap-2 justify-center">
                     Checkout
                  </button>
               </div>
            </div>
